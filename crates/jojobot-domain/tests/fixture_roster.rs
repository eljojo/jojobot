...
const ROSTER: &[&str] = &[
    ...
    "bot:contract-migrate-sender-column-delta",
    "bot:contract-migrate-sender-column-gamma",
    "bot:contract-migrate-sender-column-sigma",
    "bot:contract-migrate-permanent-ids",
    "bot:contract-migrate-permanent-ids-2",
    "bot:contract-name-taken-target",
    ...
    "person:contract-orphaned-editpath",
    "person:contract-revision-count",
    "person:contract-stands-for-basic",
    "person:contract-stands-for-clear",
    "person:contract-stands-for-decoy",
    "person:contract-stands-for-empty",
    "person:contract-stands-for-nobody",
    "person:contract-stands-for-repeat",
    "person:contract-stands-for-replace",
    "person:contract-stands-for-self",
    "person:contract-stands-for-stack",
    "person:contract-stands-for-untouched",
    ...
    "event:contract-archived-link-party",
    ...
    "person:contract-archived-link-moved-on",
    "person:contract-archived-link-still-going",
    ...
    "person:contract-field-migration-alpha",
    "person:contract-field-migration-beta",
    "person:contract-field-migration-never-existed",
    ...
    "person:contract-ref-vacancy-onlooker",
    "person:contract-injector",
    "person:contract-late-edge",
    "person:contract-lineage",
    "person:contract-listed-pointer-alpha",
    "person:contract-listed-pointer-beta",
    ...
    "person:contract-edit-pointer-author",
    "person:contract-retract-pointer-author",
    ...
    "person:rename-no-badge-was",
    "person:status-archived-alpha",
    ...
    "person:contract-refscreen-author",
    "person:contract-refscreen-duplicate",
    "person:contract-refscreen-survivor",
    "person:contract-scope-owner-was",
    "person:contract-scope-owner-now",
    ...
    "thing:contract-ref-departed",
    "thing:contract-ref-vacancy",
    ...
    "thing:contract-edit-pointer-was",
    "thing:contract-retract-pointer-was",
    "thing:contract-reused-former-handle",
    ...
    "thing:contract-supplied-merge-stored",
    ...
    "thing:contract-migrate-permanent-ids-run",
    "thing:contract-migrate-permanent-ids-skip",
    ...
    "thing:contract-view-answers-marked",
    "thing:contract-view-second-thing",
    "thing:contract-view-filter-routine",
    "thing:contract-view-filter-urgent",
    ...
    "work:contract-edit-pointer-now",
    "work:contract-retract-pointer-now",
    "work:contract-reused-former-first-gone",
    "work:contract-reused-former-second-gone",
    "work:contract-double-rename-now",
    "work:contract-retype-now",
    "work:contract-parent-now",
    "work:alias-rename-now",
    "work:rename-no-badge-now",
    "work:handcart",
    "work:red-bike",
